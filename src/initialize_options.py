...
def initialize_options(version):
	...
	# Hardcoded paths
	options['database_files_relpath'] = this_path + "../db/external_resources/Pfam_{0}/database_files/".format(version)	# Folder where the external files from the Pfam database are kept
	...
	options['pfam_pfam_filename'] = this_path + "../db/interaction_database/PfamPfam_contacts_through_all_PDBs_table.txt"
